  @extends('pelanggan.tarif.layouts.app')
      ...
      <div class="modal-content">
        ...
        <form action="{{ route('tarif.create') }}" method="post">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <label for="golongan_tarif" class="col-form-label">Golongan tarif</label>
                <input type="text" class="form-control" id="golongan_tarif" name="golongan_tarif" placeholder="Enter Golongan tarif" required>
              </div>
